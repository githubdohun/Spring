...
public class Main {
	...
	public static void main(String[] arg) {
		...
		//스프링 설정 파일 읽기
		//ApplicationContext contest = new ClassPathXmlApplicationContext()"XML 파일의 경로";
		//ApplicationContext contest = new ClassPathXmlApplicationContext("file:/src/main/java/com/test/di02/di02.xml");
